<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LocationToLocationReport.aspx.cs" Inherits="LocationToLocationReport" %>
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <table id="divExport" style="width: 100%;" valign="top">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btn_compare" CssClass="ContinueButton" runat="server" Text="Compare"
                                                                Height="25px" Width="80px" Font-Size="13px" OnClick="btn_compare_Click" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%; height: 100%;" valign="top" colspan="2">
